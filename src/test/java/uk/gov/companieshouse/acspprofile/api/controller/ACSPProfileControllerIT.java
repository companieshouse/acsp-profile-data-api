...
class ACSPProfileControllerIT {
    ...
    void shouldUpdateDocumentAndReturn200OKWhenExistingDocumentInDB() throws Exception {
        ...
        final ACSPProfileDocument expectedDocument =
                getExpectedFilingHistoryDocument(DOCUMENT_METADATA, 1,
                        List.of(new ACSPProfileAnnotation()
                                .annotation(
    ...
    void shouldReturn400BadRequestWhenInvalidFieldsSentInRequestBody() throws Exception {
        ...
        assertNull(mongoTemplate.findById(TRANSACTION_ID, ACSPProfileDocument.class));
    }
    ...
    void shouldReturn503ServiceUnavailableWhenChsKafkaApiReturnsA503ResponseOnUpsertAndDocumentShouldBeRolledBackToPreviousState()
        ...
        final ACSPProfileDocument expectedDocument = mongoTemplate.findById(TRANSACTION_ID,
                ACSPProfileDocument.class);
        ...
        assertEquals(expectedDocument, mongoTemplate.findById(TRANSACTION_ID, ACSPProfileDocument.class));
    ...
    private static ACSPProfileDocument getExpectedFilingHistoryDocument(final String documentMetadata,
                                                                        Integer pages, List<ACSPProfileAnnotation> annotations,
                                                                        ACSPProfileDeltaTimestamp updated, ACSPProfileDeltaTimestamp created) {
