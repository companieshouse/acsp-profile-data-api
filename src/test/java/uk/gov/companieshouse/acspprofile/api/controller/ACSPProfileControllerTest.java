...
import uk.gov.companieshouse.acspprofile.api.service.ACSPProfileDeleteProcessor;
import uk.gov.companieshouse.acspprofile.api.service.ACSPProfileGetResponseProcessor;
...
class ACSPProfileControllerTest {
    ...
    @InjectMocks
    private ACSPProfileController controller;
    @Mock
    private ACSPProfileUpsertProcessor upsertProcessor;
    @Mock
    private ACSPProfileGetResponseProcessor getResponseProcessor;
    @Mock
    private ACSPProfileDeleteProcessor deleteProcessor;
    ...
    void shouldReturn200OKWhenGetCompanyFilingHistoryList() {
        ...
        final ACSPProfileListRequestParams params = ACSPProfileListRequestParams.builder()
