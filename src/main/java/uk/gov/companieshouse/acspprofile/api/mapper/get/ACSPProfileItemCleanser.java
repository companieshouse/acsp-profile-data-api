...
@Component
public class ACSPProfileItemCleanser {
    ...
    public ACSPProfileItemCleanser(AssociatedFilingCleanser associatedFilingCleanser, ResolutionCleanser resolutionCleanser,
