...
@Component
public class ACSPProfileGetResponseProcessor implements GetResponseProcessor {
    ...
    public ACSPProfileGetResponseProcessor(Service filingHistoryService, ItemGetResponseMapper itemGetResponseMapper,
    ...
    @Override
    public FilingHistoryList processGetCompanyFilingHistoryList(ACSPProfileListRequestParams requestParams) {
